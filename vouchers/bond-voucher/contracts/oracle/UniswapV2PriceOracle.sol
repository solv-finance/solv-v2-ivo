...
contract UniswapV2PriceOracle is IPriceOracle, AdminControl {
    ...
    function addTokenConfig(
        ...
        emit AddTokenConfig(
            base_, baseUnit_, anchorUnit_, uniswapMarket_, 
    ...
    function refreshPrice(
        ...
        TokenConfig memory config = tokenConfigs[base_];
        Observation storage observation = observations[base_][dateSignature];
        require(
    ...
    function getObservation(
        ...
        string memory toDate = _getDateString(toDate_);
        bytes32 dateSignature = _getDateSignature(fromDate, toDate);
        return observations[base_][dateSignature];
    }
    ...
    function getPrice(
        ...
        string memory toDate = _getDateString(toDate_);
        bytes32 dateSignature = _getDateSignature(fromDate, toDate);
        return int256(observations[base_][dateSignature].price);
    }
